...
abstract class PayRequest
{
    ...
    public function resetPayload(): void
    {
        $this->payload = [
            ...
            'order_id' => uniqid('flitt_', true),
            'server_callback_url' => config('flitt.callback_url') ?: secure_url(route('flitt-payment.callback', [], false)),
    ...
    public function setRectoken(string $rectoken): self
    {
        $this->payload['rectoken'] = $rectoken;
        return $this;
    }

    public function saveCard(): self
    {
        $this->payload['required_rectoken'] = 'Y';
        return $this;
    }
